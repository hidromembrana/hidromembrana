        ...
        <div className="bg-background min-h-screen">
            <div className="container mx-auto px-4 md:px-6 py-12 max-w-4xl">
                ...
                <p className="text-xl text-muted-foreground mb-12">
                    Regulaciones de uso, cotización y servicios.
                </p>
                <div className="max-w-none">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">1. Objeto y Naturaleza del Sitio</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">2. Especificaciones de Productos y Servicios</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">3. Proceso de Cotización</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">4. Precios</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">5. Despachos y Ejecución de Servicios</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">6. Propiedad Intelectual</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">7. Limitación de Responsabilidad</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-foreground">8. Legislación Aplicable y Jurisdicción</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
